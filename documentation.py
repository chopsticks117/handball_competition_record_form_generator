...
def create_docx_from_template(template_path, matches, referees, output_folder="/Users/tszhowong/Desktop/Handball/Referee/Application/data"):
    # Load the template .docx file
    doc = Document(template_path)

    # Replace placeholders with actual values
    replace_placeholder(doc, "{{比賽日期}}", matches[0]['日期'])
